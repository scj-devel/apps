...
import privmem.minepumplog.actuators.GenericActuator;
...
import privmem.minepumplog.scj.PeriodicWaterLevelDetectionEventHandler;
import privmem.minepumplog.sensors.HighWaterSensor;
import privmem.minepumplog.sensors.LowWaterSensor;
...
public class MainMission extends Mission {
	...
	protected void initialize() {
		...
		PeriodicMethaneDetectionEventHandler methane = new PeriodicMethaneDetectionEventHandler(
			...
			methaneSensor, waterpumpActuator, log);
		methane.register();		
