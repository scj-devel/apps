 ...
 ******************************************************************************/
package privmem.minepump.actuators;

import privmem.minepump.actuators.GenericActuator;
import privmem.minepump.legosim.lib.Motor;
...
public class WaterpumpActuator extends GenericActuator {
	...
	// THE FOLLOWING CODE IS USED IN privmem.minepump.tex !!!!
    public synchronized void start() {
        if (this.emergencyState == false) {
            super.start();
        }    
    }
    // THE PREVIOUS CODE IS USED IN privmem.minepump.tex !!!!
